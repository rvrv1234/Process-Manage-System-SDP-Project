...
const addInventoryItem = async (req, res) => {
    ...
    try {
        const result = await pool.query(
            "INSERT INTO inventory (name, category, stock, unit, price, status) VALUES ($1, $2, $3, $4, $5, 'In Stock') RETURNING *",
...
const updateInventoryItem = async (req, res) => {
    ...
    try {
        ...
        const result = await pool.query(
            "UPDATE inventory SET stock = $1, price = $2, name = $3, category = $4, unit = $5, last_updated = CURRENT_TIMESTAMP WHERE inventory_id = $6 RETURNING *",
